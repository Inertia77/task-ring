...
function ensureTimeDetailModal(){
  ...
  m.setAttribute("aria-hidden","true");
  m.innerHTML=`<div class="timeDetailCard" role="dialog" aria-modal="true"><div class="timeDetailHead"><div><span>TIME DETAIL</span><b id="timeDetailTitle">时间明细</b></div><button type="button" class="timeDetailClose" data-time-modal-close title="关闭" aria-label="关闭">×</button></div><div class="timeDetailBody" id="timeDetailBody"></div></div>`;
